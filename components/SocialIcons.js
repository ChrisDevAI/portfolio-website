...
import { FaGithub, FaLinkedin, FaXTwitter, FaMedium, FaChessKnight } from "react-icons/fa6";
...
export default function SocialIcons() {
  return (
    <div className="flex justify-center gap-8 mb-8 text-3xl text-gray-400">
      ...
      <a
        href="https://medium.com/@ChrisDevAI"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Medium"
      >
      ...
      >
        <FaChessKnight className="text-gray-400 hover:text-white transition" />
      </a>
    </div>
  );
}
